# This Makefile is for the Finance::Bank::HSBC extension to perl.
#
...
#	AUTHOR => q[Chris Ball <chris@cpan.org>]
#	NAME => q[Finance::Bank::HSBC]
#	PREREQ_PM => { HTML::TokeParser=>q[0], WWW::Mechanize=>q[0] }
#	VERSION_FROM => q[HSBC.pm]
...
DISTNAME = Finance-Bank-HSBC
NAME_SYM = Finance_Bank_HSBC
VERSION = 1.00
VERSION_SYM = 1_00
XS_VERSION = 1.00
INST_BIN = blib/bin
...
FULLEXT = Finance/Bank/HSBC
BASEEXT = HSBC
PARENT_NAME = Finance::Bank
DLBASE = $(BASEEXT)
VERSION_FROM = HSBC.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
manifypods : pure_all HSBC.pm
	@$(POD2MAN) \
	HSBC.pm \
	$(INST_MAN3DIR)/Finance::Bank::HSBC.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Finance-Bank-HSBC\" VERSION=\"1,00,0,0\">\n}. qq{\t<TITLE>Finance-Bank-HSBC</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR>Chris Ball &lt;chris\@cpan.org&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"HTML-TokeParser\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"WWW-Mechanize\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Finance-Bank-HSBC.ppd
